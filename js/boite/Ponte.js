...
class BoitePonte extends Boite
{
    constructor()
    {
        ...
        super("o_boitePonte", "Lanceur de Ponte", `<div id='o_ponteContent'><table class='o_maxWidth'>
                ...
                <tr><td>${NOM_RAC_UNITE[1]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[1] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre1'/></td><td><input name='o_jour1' value='0' size='3'/></td><td><input name='o_heure1' value='0' size='2'/></td><td><input name='o_minute1' value='0' size='2'/></td><td><input name='o_seconde1' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[7] >= 1 ? "<img id='o_lancer1' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[2]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[2] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre2'/></td><td><input name='o_jour2' value='0' size='3'/></td><td><input name='o_heure2' value='0' size='2'/></td><td><input name='o_minute2' value='0' size='2'/></td><td><input name='o_seconde2' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[7] >= 3 ? "<img id='o_lancer2' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[3]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[3] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre3'/></td><td><input name='o_jour3' value='0' size='3'/></td><td><input name='o_heure3' value='0' size='2'/></td><td><input name='o_minute3' value='0' size='2'/></td><td><input name='o_seconde3' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[8] >= 4 ? "<img id='o_lancer3' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[4]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[4] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre4'/></td><td><input name='o_jour4' value='0' size='3'/></td><td><input name='o_heure4' value='0' size='2'/></td><td><input name='o_minute4' value='0' size='2'/></td><td><input name='o_seconde4' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[7] >= 7 ? "<img id='o_lancer4' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[5]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[5] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre5'/></td><td><input name='o_jour5' value='0' size='3'/></td><td><input name='o_heure5' value='0' size='2'/></td><td><input name='o_minute5' value='0' size='2'/></td><td><input name='o_seconde5' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[8] >= 9 ? "<img id='o_lancer5' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[6]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[6] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre6'/></td><td><input name='o_jour6' value='0' size='3'/></td><td><input name='o_heure6' value='0' size='2'/></td><td><input name='o_minute6' value='0' size='2'/></td><td><input name='o_seconde6' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[7] >= 10 && monProfilJoueur.niveauRecherche[7] >= 5 ? "<img id='o_lancer6' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[8]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[8] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre8'/></td><td><input name='o_jour8' value='0' size='3'/></td><td><input name='o_heure8' value='0' size='2'/></td><td><input name='o_minute8' value='0' size='2'/></td><td><input name='o_seconde8' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[7] >= 11 && monProfilJoueur.niveauRecherche[8] >= 1 ? "<img id='o_lancer8' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[9]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[9] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre9'/></td><td><input name='o_jour9' value='0' size='3'/></td><td><input name='o_heure9' value='0' size='2'/></td><td><input name='o_minute9' value='0'  size='2'/></td><td><input name='o_seconde9' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[8] >= 13 && monProfilJoueur.niveauRecherche[8] >= 5 ? "<img id='o_lancer9' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[10]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[10] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre10'/></td><td><input name='o_jour10' value='0' size='3'/></td><td><input name='o_heure10' value='0' size='2'/></td><td><input name='o_minute10' value='0' size='2'/></td><td><input name='o_seconde10' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[8] >= 17 ? "<img id='o_lancer10' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[11]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[11] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre11'/></td><td><input name='o_jour11' value='0' size='3'/></td><td><input name='o_heure11' value='0' size='2'/></td><td><input name='o_minute11' value='0' size='2'/></td><td><input name='o_seconde11' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[8] >= 23 && monProfilJoueur.niveauRecherche[7] >= 15 ? "<img id='o_lancer11' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[13]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[13] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre13'/></td><td><input name='o_jour13' value='0' size='3'/></td><td><input name='o_heure13' value='0' size='2'/></td><td><input name='o_minute13' value='0' size='2'/></td><td><input name='o_seconde13' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[7] >= 25 && monProfilJoueur.niveauRecherche[9] >= 4 ? "<img id='o_lancer13' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[14]}</td><td>${BoitePonte.arrondiTemps(TEMPS_UNITE[14] * Math.pow(0.9, tdp))}</td><td><input value='0' size='15' name='o_nombre14'/></td><td><input name='o_jour14' value='0' size='3'/></td><td><input name='o_heure14' value='0' size='2'/></td><td><input name='o_minute14' value='0' size='2'/></td><td><input name='o_seconde14' value='0' size='2'/></td><td class='cursor'>${(monProfilJoueur.niveauConstruction[8] >= 28 && monProfilJoueur.niveauRecherche[9] >= 7 ? "<img id='o_lancer14' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
