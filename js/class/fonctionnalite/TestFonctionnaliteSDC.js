Utils.register(class TestFonctionnaliteSDC extends FonctionnaliteAlliance {
    ...
    async _testJoueurSDC() {
        try {
            ...
            const joueursCharges = await this.chargerObjetsForum(Joueur);
            ...
            const joueursRecharges = await this.chargerObjetsForum(Joueur);
            ...
            const joueurInterne = new Joueur(this, { donneesInitiales: { 'Pseudo': 'momsoubob', 'Alliance Rattachement': 'TEST' } });
            ...
            const joueurExterne = new Joueur(this, { donneesInitiales: { 'Pseudo': 'arpegor', 'Alliance Rattachement': 'AUTRE' } });
