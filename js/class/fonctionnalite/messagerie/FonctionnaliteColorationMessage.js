 ...
 * Remplace l'ancienne logique de PageMessagerie.chargerJoueurs.
 * 
 * @class FonctionnaliteColorationMessage
 * @extends {FonctionnaliteAlliance}
 */
Utils.register(class FonctionnaliteColorationMessage extends FonctionnaliteAlliance {

    static ABREVIATIONS_HISTORY = ['FCM'];
