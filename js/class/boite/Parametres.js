...
* @extends Boite
*/
Utils.register(class BoiteParametre extends Boite {

    /**
     *
     */
    #paramStyle = ["couleurTitre", "couleur1", "couleur2", "couleur3", "couleurTexte", "dockPosition", "dockVisible", "boiteShow", "boiteHide"];
    /**
    *
    */
    #paramGeneral = ["affectationRessource", "methodeFlood", "uniteAntisondeTerrain", "uniteAntisondeDome", "uniteSonde"];
    /**
    *
    */
    #paramTraceur = ["etatTraceurJoueur", "intervalleTraceurJoueur", "nbPageTraceurJoueur", "etatTraceurAlliance", "intervalleTraceurAlliance"];
    ...
    */
    #parametreUtilitaire() {
        if (sectionsRequises) {
            ...
            console.error("[BoiteParametre] sectionsRequises est indéfini.");
        }
    ...
    */
    #parametreGeneral() {
        $("#o_tabsParametre1").append(`<form>
            ...
            ${monProfilUtilisateur.parametre[this.#paramGeneral[1]].getForm()}
            ...
            ${monProfilUtilisateur.parametre[this.#paramGeneral[2]].getForm() + monProfilUtilisateur.parametre[this.#paramGeneral[3]].getForm() + monProfilUtilisateur.parametre[this.#paramGeneral[4]].getForm()}
        </form>`);
        return this;
    }
    /**
    ...
    */
    #parametreTraceur() {
        $("#o_tabsParametre4").append(`<form>
            ...
            ${monProfilUtilisateur.parametre[this.#paramTraceur[3]].getForm() + monProfilUtilisateur.parametre[this.#paramTraceur[4]].getForm()}
        </form>`);
        return this;
    }
});
