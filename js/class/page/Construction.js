...
* @constructor
*/
Utils.register(class Construction extends Page {
    ...
    */
    async titleEtable() {
        ...
        let title = `<table>
            ...
            <tr><td>Capacité de livraison actuelle</td><td class='right'>${numeral(ouvDispo * (10 + (constructions[11] / 2))).format()}</td></tr>
            <tr><td>Perte ouvrières pour niveau ${(constructions[11] + 1)}</td><td class='right'>${numeral(perte).format()}</td></tr>
