	...
	*/
	afficherCommande()
	{
        ...
        $("#o_tableListeCommande").DataTable({
            ...
            columnDefs : [
                {targets : 2}, // Nouvelle colonne Évolution
                ...
                {visible: false, targets: [3, 4, 1, 2]} // Indices ajustés pour masquer les colonnes de quantité demandée, la date commande originale et l'évolution
            ]
        });
