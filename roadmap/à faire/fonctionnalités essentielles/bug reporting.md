...
- Créer une fonction utilitaire de post des logs qui :
    ...
    - Envoie un second message contenant les logs (à splitter en plusieurs messages si au-delà de la limite de caractères)
    - Optionellement, voir si un mécanisme de reporting plus abouti existe (via gitHub issues + import dans auto-claude?)
...
- Ajouter des logs d'entrée et sortie pour chaque fonction, quelle que soit l'issue
