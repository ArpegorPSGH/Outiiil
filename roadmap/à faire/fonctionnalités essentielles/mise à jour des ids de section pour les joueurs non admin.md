...
- Tout joueur ayant accès au forum caché devra automatiquement, au chargement de toute page, récupérer les ids de section (caché + restreint), et s'en servir pour mettre à jour si nécessaire un objet d'ids sections stocké dans une section restreinte.
