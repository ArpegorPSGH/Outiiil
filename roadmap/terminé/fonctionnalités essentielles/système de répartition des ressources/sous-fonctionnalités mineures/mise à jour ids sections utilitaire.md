...
2.  Si les IDs stockés dans les paramètres de l'extension sont manquants ou incorrects, scanner le DOM de la page Forum pour trouver les IDs corrects des sections nommées "Membres Outiiil" et "Commandes Outiiil".
...
1.  **Test sur la page Forum avec IDs incorrects/manquants :**
    *   Modifier manuellement les IDs des sections "Commandes Outiiil" et "Membres Outiiil" dans les paramètres de l'extension (par exemple, via le `localStorage` du navigateur) pour qu'ils soient incorrects ou les supprimer.
    *   Aller sur la page Forum.
    *   Vérifier qu'un popup de notification s'affiche, indiquant que les IDs ont été mis à jour.
    *   Vérifier dans les paramètres de l'extension que les IDs des sections "Commandes Outiiil" et "Membres Outiiil" ont été correctement mis à jour avec les IDs réels des sections sur le forum.
...
2.  **Test sur la page Forum avec IDs corrects :**
    *   S'assurer que les IDs des sections "Commandes Outiiil" et "Membres Outiiil" dans les paramètres de l'extension sont corrects.
    *   Aller sur la page Forum.
