...
5. Prioritè du grade -> Priorité du grade
...
5.  Identifier et modifier la chaîne de texte "Prioritè du grade" pour la remplacer par "Priorité du grade" dans le fichier concerné (probablement `js/boite/Grade.js`).
...
5. Vérifier que le texte "Prioritè du grade" est remplacé par "Priorité du grade".
